...
public class JdbcRealmTest {
	private static final Logger logger = LoggerFactory.getLogger(JdbcRealmTest.class);
	...
	public void checkLogin() {
        ...
        assertThat(subject.getPrincipal().toString(),is("zhou"));
	}
    @Test
    public void checkErrorLogin() {
        Subject subject = login("zhou", "12342");
